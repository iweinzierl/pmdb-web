...
import {MoviesResource, MovieSearchResource} from "../http.jsx";
...
class MovieCreateApp extends React.Component {
        ...
        return (
            <div className="movie-form-wrapper">
                <div className="movie-form">
                    ...
                    <div className="movie-form-side">
                        <div className="movie-form-input">
                            <label>Title</label>
                            <TextField name="title" value={this.state.title} hintText="Title" onChange={this.handleTitle.bind(this)}
                                       onKeyPress={this.handleTitleEnter.bind(this)} fullWidth={true}/>
                        </div>

                        <div className="movie-form-input">
                            <label>Length</label>
                            <TextField name="length" value={this.state.length} fullWidth={true} hintText="Length in minutes"
                                       onChange={this.handleLength.bind(this)}/>
                        </div>

                        <div className="movie-form-input">
                            <label>Release Date</label>
                            <TextField name="releaseDate" value={this.state.publishDate} fullWidth={true}
                        ...
                        <div className="movie-form-input">
                            ...
                            <TextField name="description" value={this.state.description} fullWidth={true}
                    ...
                    <div className="movie-form-side">
                        <div className="movie-form-input">
                            ...
                            <TextField name="coverUrl" value={this.state.coverUrl} fullWidth={true} hintText="http://cover.movie.org"
                        ...
                        <div className="movie-form-input">
                            <label>Format</label>
                            <SelectField value={this.state.format} onChange={this.handleFormat.bind(this)}
                                         fullWidth={true}>
                ...
                <div className="movie-form-suggestions">
                    <MovieTable key="suggestions" movies={this.state.suggestions}
    ...
    onSuggestionClicked(movie) {
        ...
        const self = this;
        new MovieSearchResource(UserStore.getState().accessToken).get(
            movie.id,
    ...
    onSubmit() {
        ...
        new MoviesResource(UserStore.getState().accessToken).post(
            movie,
            (data) => {
                alertify.success("Movie added!");
                MovieStore.dispatch(ActionCreators.newAddMovieAction(data));
            },
    ...
    search() {
        ...
        new MovieSearchResource(UserStore.getState().accessToken).search(
            this.state.title,
            function (movies) {
                self.setState({
                    suggestions: movies
